...
if 'mwd_frame' not in st.session_state: st.session_state.mwd_frame=0
...
for buoy in selected_buoys:
    ...
    folium.CircleMarker([lat,lon],radius=6,color='red',fill=True,fill_opacity=0.7,popup=f"Buoy {buoy}").add_to(m)
